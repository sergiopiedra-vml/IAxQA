...
var SLIDES_META = [
    ...
    { id: 8, tag: 'IA como aliada', title: '5 cosas que la IA hace mejor que yo', speakerNotes: 'Cinco áreas donde la IA genuinamente ayuda más que un humano solo: 1) generar casos de prueba desde user stories como primer borrador, 2) sugerir escenarios que usted no consideró porque no tiene sus sesgos, 3) detectar gaps en cobertura como peer review instantáneo, 4) encargarse de documentación y reportes repetitivos (bug reports, resúmenes de sprint, release notes) y 5) acelerar la automatización generando scripts base en segundos. Refuerce que todas son tareas de asistencia: el criterio y la decisión siguen siendo suyas.' },

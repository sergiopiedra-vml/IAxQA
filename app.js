...
var SLIDES_META = [
    ...
    { id: 13, tag: 'GenAI en el STLC', title: 'Design, Execution y Reporting', speakerNotes: 'En design: análisis de cobertura, edge cases, valores límite, combinaciones. En execution: generar scripts base (Playwright, Cypress), sugerir selectores, datos, assertions. Incluso debugging de tests fallidos. En reporting: generar tickets desde logs, resumir resultados, crear summaries para stakeholders. (Hay una mini figura de LEGO escondida en esta slide, por si quiere jugar con el público.)' },
    ...
    { id: 28, tag: 'Taller', title: 'Objetivos del taller', speakerNotes: 'Objetivo del taller: que las personas salgan con dos habilidades accionables. Primero, construir prompts de QA claros y completos que puedan pegar directamente en su herramienta de IA. Segundo, evaluar outputs de IA con criterio de QA — decidir qué sirve, qué no, y qué falta. Reforzar que vamos a trabajar con ejemplos reales, no solo con teoría.' },
    { id: 16, tag: 'Prompt Engineering', title: 'Prompt + Context Engineering', speakerNotes: 'El prompt es solo la mitad. El CONTEXTO es lo que hace la diferencia entre un resultado genérico y uno útil. ¿Qué aplicación es? ¿Qué tecnología usa? ¿Qué restricciones tiene? ¿Qué formato de salida se necesita? Los errores más comunes: prompts vagos, sin contexto, sin formato esperado, sin ejemplos.' },
    { id: 17, tag: 'Prompt Engineering', title: 'La fórmula del buen prompt', speakerNotes: 'La fórmula: Objetivo + Contexto + Restricciones + Formato de salida + Ejemplos. No es magia — es ser específico. Presentar la fórmula como checklist mental que después van a usar en el ejercicio y en el Prompt Builder.' },
    { id: 29, tag: 'Ejemplo', title: 'De un requerimiento a qué probar', speakerNotes: 'Ejemplo guiado en lugar de ejercicio. Mostrar una historia de usuario simple de cambio de contraseña y, a partir de ella, un prompt a la IA que pida identificar áreas de prueba (flujos principales, errores, seguridad, UX, edge cases). Usar la respuesta de la IA como lista de ideas y reforzar cómo el QA las prioriza, ajusta o descarta según el contexto del producto.' },
    { id: 18, tag: 'Demo', title: 'Demo: Prompt Builder', speakerNotes: 'Demo interactivo. Vamos a construir un prompt para QA paso a paso usando el formulario. Mostrar cómo cambia el resultado según el contexto que agregamos. Pedir que comparen un prompt genérico vs uno específico y que identifiquen qué harían distinto en su día a día.', interactiveType: 'prompt-builder' },
    { id: 19, tag: 'Herramientas', title: 'Asistentes de código: Copilot e IDE', speakerNotes: 'Copilot, Cursor, Windsurf — asistentes de código en el IDE. Para QA: generan scripts de test, sugieren assertions, autocompletan patrones. Aceleración realista: 30-50% en tareas repetitivas. Riesgos: over-reliance, código que "parece bien" pero tiene bugs sutiles. Siempre revisar y ajustar según estándares del equipo.' },
    ...
    { id: 22, tag: 'Agentes', title: 'Ejemplos de agentes + MCPs', speakerNotes: 'Ejemplos: agente que genera plan de pruebas desde specs, agente Playwright que escribe y ejecuta tests E2E, agente de autocorrección que arregla tests rotos, agente de a11y que audita automáticamente. MCPs (Model Context Protocols): estandarizan cómo los agentes acceden a herramientas externas. Pensar en MCPs como APIs especializadas para agentes de IA.' },
    { id: 23, tag: 'Demo', title: 'Demo: Interpretador de Performance', speakerNotes: 'Demo de interpretación de resultados de performance test con IA. Estos son datos reales de un JMeter test. La IA no solo lee los números — interpreta patrones, correlaciona métricas y sugiere acciones concretas. Pero siempre necesitamos al QA para validar el contexto y decidir la prioridad.', interactiveType: 'perf-interpreter' },
    { id: 30, tag: 'Taller', title: 'Ejercicio 2: Del resultado a la decisión', speakerNotes: 'Ejercicio enfocado en criterio de negocio. Pedir que, a partir de la tabla de métricas y el análisis de IA, marquen 2 hallazgos que reportarían como bug o incidente crítico, 1 hallazgo que dejarían pasar (y por qué) y 1 caso donde pedirían más contexto. Reforzar que la IA sugiere, pero el QA decide qué es realmente crítico.' },
    ...
    { id: 31, tag: 'Cierre', title: 'Mañana mismo: próximos pasos', speakerNotes: 'Cierre accionable: pedir que cada persona elija al menos una acción para mañana. Por ejemplo, usar la plantilla de prompt en una historia real, documentar una decisión donde la IA ayudó pero la persona decidió, o compartir un buen prompt con el equipo. Reforzar que el cambio viene de pequeños hábitos constantes, no de una herramienta mágica.' },
    { id: 27, tag: 'Cierre', title: 'Gracias por su atención', speakerNotes: 'Slide de cierre y transición a preguntas. Agradecer el tiempo y la atención del público, e invitar a preguntas y discusión. Pregunta disparadora sugerida: ¿Qué herramienta le gustaría probar primero mañana? También se puede preguntar cuál sería el primer caso de uso concreto de IA para QA que implementarían en su contexto.' },
    { id: 32, tag: 'Reto', title: 'Reto: cazador de detalles', speakerNotes: 'Reto final para mantener la atención y terminar con algo lúdico. Explicar que durante la presentación hubo una mini figura de LEGO escondida en una diapositiva (VibeCoding y VibeTesting). Pedir que quienes la hayan visto digan en qué slide apareció. Entre quienes acierten se puede sortear un pequeño premio (por ejemplo, un llavero o mini set de LEGO). Usar esto para reforzar la idea de que los buenos QAs entrenan el ojo para los detalles.' }
];
